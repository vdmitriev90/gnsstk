...
namespace pod
{
	...
	void TropoGradEquations::updateH(const gnsstk::IRinex& gData, const gnsstk::TypeIDSet & obsTypes, gnsstk::Matrix<double>& H, int & col_0)
	{
    ...
    void TropoGradEquations::defStateAndCovariance(gnsstk::Vector<double>& x, gnsstk::Matrix<double>& P, int & index) const
    {
        x(index) = 5.000e-02;
        P(index, index) = 5e-5;
		++index;
