...
namespace pod
{
    ...
    class SolverPPP : public gnsstk::CodeKalmanSolver
    {
      public:
         ...
         */
        SolverPPP(bool isUseAdvClkModel = false,
                  double tropoQ = 6e-10,
      ...
      private:
        ...
        /// Initializing method.
        void Init(bool isUseAdvClkModel = false,
                  double tropoQ = 6e-10,
                  double posSigma = 100.0,
                  double clkSigma = 30000.0,
                  double weightFactor = 10000.0);
        ...
        void updateMatrices(gnsstk::Matrix<double>& phiMatrix,
                            gnsstk::Matrix<double>& qMatrix,
                            gnsstk::IRinex& gData);
        ...
        virtual SolverPPP& setDefaultEqDefinition(const gnsstk::gnssEquationDefinition& eqDef)
        {
            return (*this);
        };
