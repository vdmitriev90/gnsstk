...
#ifndef POD_SOLVERPPPFB_HPP
#define POD_SOLVERPPPFB_HPP
...
namespace pod
{
    ...
    class SolverPPPFB : public SolverPPP
    {
      public:
         ...
         */
        SolverPPPFB(bool isUseAdvClkModel = false,
                    double tropoQ = 6e-10,
      ...
      private:
        ...
        virtual SolverPPPFB& setDefaultEqDefinition(const gnsstk::gnssEquationDefinition& eqDef)
        {
            return (*this);
        };
