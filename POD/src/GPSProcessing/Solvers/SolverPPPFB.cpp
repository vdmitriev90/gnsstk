...
namespace pod
{
     ...
     */
    SolverPPPFB::SolverPPPFB(bool isUseAdvClkModel,
                             double tropoQ,
                             double posSigma,
                             double clkSigma,
                             double weightFactor)
        ...
        try
        {
            ...
            for (size_t i = 0; i < maxSize; i++)
            {
                ...
                for (auto pos = ObsData.begin(); pos != ObsData.end(); ++pos)
                {
                    ...
                    {
                        Exception e("Rejected all satellites at reprocessing part, check phase and "
                                    "code limits");
                        GNSSTK_THROW(e);
                    }
    ...
    void SolverPPPFB::checkLimits(IRinex& gData, double codeLimit, double phaseLimit)
    {
