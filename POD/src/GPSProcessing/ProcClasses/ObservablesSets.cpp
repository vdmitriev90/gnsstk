...
namespace pod
{
    namespace obs_sets
    {
        ...
        inline static const TypeIDSet
            dualFreqGpsGloTypes{TypeID::C1, TypeID::P2, TypeID::L1, TypeID::L2, TypeID::LLI1, TypeID::LLI2, TypeID::S1};
    ...
    RequireObservablesBuilder::RequireObservablesBuilder(const SatSystSet& systems, bool keepOnlyRequiredTypes)
        : systems_(systems)
