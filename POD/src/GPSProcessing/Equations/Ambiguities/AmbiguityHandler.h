...
namespace pod
{
    ...
    {
      public:
        AmbiguityHandler(const ParametersSet& ambiguites,
      ...
      private:
        void storeDDAmbiguities(gnsstk::IRinex& gData,
                                const gnsstk::Vector<double>& ddFixedAmb,
                                const gnsstk::SatIDSet& refSVs) const;

        gnsstk::Vector<double> fixDDAmbSeparately(const gnsstk::Vector<double>& ddAmbFloat,
