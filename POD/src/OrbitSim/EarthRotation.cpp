...
namespace pod
{
    EarthRotation::EarthRotation(const EOPStore& eop) : eopData_(eop) {}
    ...
    Matrix<double> EarthRotation::getJ2k2Ecef00(const CommonTime& t)
    {
        ...
        // double timeTAI = (60.0*(double)(60 * ct_TAI.hour + ct_TAI.minute) + ct_TAI.second) /
        // DAYSEC;
        //
    ...
    CivilTime toTAI(const CommonTime& t)
    {
        ...
        double dTAI =
            gnsstk::getTimeSystemCorrection(inTS, TimeSystem::TAI, ct.year, ct.month, ct.day);
