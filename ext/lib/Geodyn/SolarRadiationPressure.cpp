...
#ifdef GNSSTK_SOLRADPRESS_UNUSED
...
#endif  // GNSSTK_SOLRADPRESS_UNUSED
      
      double Ls = 3.823e26; //* STK [W]
      double factor = reflectCoeff * (crossArea/dryMass) * Ls 
                    / (4.0*gnsstk::PI*ASConstant::SPEED_OF_LIGHT*dcubed); // STK HPOP method
