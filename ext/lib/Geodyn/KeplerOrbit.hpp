...
#ifndef GNSSTK_KEPLER_ORBIT_HPP
#define GNSSTK_KEPLER_ORBIT_HPP
...
namespace gnsstk
{
   ...
   public:
      ...
      static Vector<double> State( double GM, const Vector<double>& Kep, double dt );
          ...
          */
      static gnsstk::Matrix<double> StatePartials ( double GM, const Vector<double>& Kep, double dt );
