...
#ifndef GNSSTK_SAT_ORBIT_PROPAGATOR_HPP
#define GNSSTK_SAT_ORBIT_PROPAGATOR_HPP
...
namespace gnsstk
{
       ...
       * gnsstk::Vector<double> rv0(6,0.0);
       * rv0(0) = 2682920.8943;
       * rv0(1) = 4652720.5672;
       * rv0(2) = 4244260.0400;
       * rv0(3) = 2215.5999;
...
//std::ostream& operator<<(std::ostream& s, const gnsstk::SatOrbitPropagator& op);


#endif   // GNSSTK_SAT_ORBIT_PROPAGATOR_HPP
