...
namespace gpstk
{
   ...
   TypeID::Initializer::Initializer()
   {
      ...
      tStrings[BLC]        = "Ambiguity LC";
      tStrings[BWL]        = "Ambiguity WL";
      tStrings[BWL2]       = "Ambiguity WL2";
      tStrings[BWL3]       = "Ambiguity WL3";
      tStrings[BWL4]       = "Ambiguity WL4";
      ...
      tStrings[prefitP1]   = "Prefit residual CodeP1";
      tStrings[prefitP2]   = "Prefit residual CodeP2";
      tStrings[prefitL1]   = "Prefit residual PhaseL1";
      tStrings[prefitL2]   = "Prefit residual PhaseL2";

      tStrings[postfitP1]  = "Postfit residual CodeP1";
      tStrings[postfitP2]  = "Postfit residual CodeP2";
      tStrings[postfitL1]  = "Postfit residual PhaseL1";
      tStrings[postfitL2]  = "Postfit residual PhaseL2";

      tStrings[prefitC5]   = "Prefit residual CodeC5";
      tStrings[prefitL5]   = "Prefit residual PhaseL5";
      tStrings[postfitC5]  = "Postfit residual CodeC5";
      tStrings[postfitL5]  = "Postfit residual PhaseL5";

      tStrings[prefitPC] = "Prefit residual PC";
      tStrings[prefitLC] = "Prefit residual LC";
      tStrings[postfitPC] = "Postfit residual PC";
      tStrings[postfitLC] = "Postfit residual LC";

      tStrings[prefitGRAPHIC1]  = "Prefit residual GRAPHIC1";
      tStrings[prefitGRAPHIC2]  = "Prefit residual GRAPHIC2";
      tStrings[postfitGRAPHIC1] = "Postfit residual GRAPHIC1";
      tStrings[postfitGRAPHIC2] = "Postfit residual GRAPHIC2";
      tStrings[prefitMWubbena]   = "Prefit MWubbena";
      tStrings[prefitWL]   = "Prefit residual WL";
      tStrings[prefitWL2]  = "Prefit residual WL2";
      tStrings[prefitWL3]  = "Prefit residual WL3";
      tStrings[prefitWL4]  = "Prefit residual WL4";
      tStrings[postfitWL]  = "Postfit residual WL";
      tStrings[postfitWL2] = "Postfit residual WL2";
      tStrings[postfitWL3] = "Postfit residual WL3";
      tStrings[postfitWL4] = "Postfit residual WL4";
      tStrings[prefitC]    = "Prefit residual Code";
      tStrings[prefitL]    = "Prefit residual Phase";
      tStrings[postfitC]   = "Postfit residual Code";
      tStrings[postfitL]   = "Postfit residual Phase";
      tStrings[dx]         = "dx";
      tStrings[dy]         = "dy";
      tStrings[dz]         = "dz";
      tStrings[cdt]        = "cdt";
      ...
      tStrings[recVY]      = "Rx Velocity Y";
      tStrings[recVZ]      = "Rx Velocity Z";
      tStrings[recAX]      = "Rx Acceleration X";
      tStrings[recAY]      = "Rx Acceleration Y";
      tStrings[recAZ]      = "Rx Acceleration Z";
