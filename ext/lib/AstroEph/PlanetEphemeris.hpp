...
namespace gnsstk
{
   ...
   public:
      ...
      gnsstk::CommonTime startTime(void) const
      { return gnsstk::MJD(startJD - gnsstk::MJD_TO_JD); }

         /// Return the end time of the data
      gnsstk::CommonTime endTime(void) const
      { return gnsstk::MJD(endJD - gnsstk::MJD_TO_JD); }
