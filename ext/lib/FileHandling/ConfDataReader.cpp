...
namespace gnsstk
{
    ...
    void ConfDataReader::loadData(void)
    {
        ...
        while (1)
        {
            try
            {
                ...
                if (line.size() > 255)
                {
                    ConfigurationException e("Line too long in configuration file '" + filename
                                             + "'.");
                    GNSSTK_THROW(e);
                }
                // Skip the blank line
                ...
                if (!(idx == std::string::npos))
                {
                    ...
                    if (!(idx2 == std::string::npos))
                    {
                        ...
                        else
                        {
                            ...
                            ConfigurationException e("Section name '" + line
                    ...
                    else
                    {
                        ...
                        ConfigurationException e("Section line '" + line
                                                 + "' in configuration file '" + filename
                ...
                if (!(idx == std::string::npos))
                {
                    ...
                    else
                    {
                        ...
                        ConfigurationException e("Variable name '" + variable
                                                 + "' in configuration file '" + filename
                                                 + "' does not comply with rules.");
     ...
     *
     */
    string ConfDataReader::getValue(string variable, string section, string defaultVal)
    {
     ...
     *
     */
    bool ConfDataReader::getValueAsBoolean(string variable, string section, bool defaultVal)
    {
     ...
     * 'variableList'.
     */
    string ConfDataReader::fetchListValue(string variableList, string section, string defaultVal)
    {
                                                 ...
                                                 bool defaultVal)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if ((result == "FALSE") || (result == "")) // If list is empty returns false
                {
                ...
                else
                {
                    ...
                    ConfigurationException e(
                        "Variable list '" + variableList + "' in configuration file '" + filename
                        + "' have a value that is neither TRUE " + "nor FALSE.");
     ...
     * @param section        Section the variable list belongs to.
     */
    ConfDataReader::ListIterator ConfDataReader::getListIterator(string variableList,
                                                                 string section)
    {
     ...
     * @param section        Section the variable list belongs to.
     */
    std::vector<std::string> ConfDataReader::getValueList(string variableList, string section)
    {
        try
        {
            // Let's make sure that section and variable names are uppercase
     ...
     * @param section        Section the variable list belongs to.
     */
    std::vector<double> ConfDataReader::getValueListAsDouble(string variableList, string section)
    {
        try
        {
    ...
    Triple ConfDataReader::getValueListAsTriple(std::string variableList,
                                                        std::string section)
    {
        std::vector<double> vals = getValueListAsDouble(variableList, section);
        if (vals.size() < 3)
        {
            ConfigurationException e("Variable '" + variableList
                + "' in section '" + section
                + "' requires at least 3 values for Triple, but only "
                + StringUtils::asString(static_cast<int>(vals.size()))
                + " found.");
            GNSSTK_THROW(e);
        }
        Triple result(vals[0], vals[1], vals[2]);
        return result;
    }
     ...
     * @param section        Section the variable list belongs to.
     */
    std::vector<int> ConfDataReader::getValueListAsInt(string variableList, string section)
    {
        try
        {
            std::vector<std::string> stringList = getValueList(variableList, section);
     ...
     *
     */
    string ConfDataReader::getVariableDescription(string variable, string section)
    {
     ...
     *
     */
    string ConfDataReader::getValueDescription(string variable, string section)
    {
     ...
     *
     */
    bool ConfDataReader::ifExist(string variable, string section)
    {
        ...
        if (it != confData.end())
        {
            ...
            else
            {
                ...
                if (issueException)
                {
                    ...
                    ConfigurationException e("Variable '" + variable + "' in section '" + section
        ...
        else
        {
            ...
            if (issueException)
            {
                ...
                if (section == "DEFAULT")
                {
                    ...
                    ConfigurationException e("Section 'DEFAULT' in configuration file '" + filename
                                             + "' does not exist. Does file '" + filename
                                             + "' exist?. Do you have "
                ...
                else
                {
                    ...
                    // Throw an exception if section name doesn't exist
                    ConfigurationException e("Section '" + section + "' in configuration file '"
