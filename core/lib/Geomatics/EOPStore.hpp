      ...
      public:
        ...
        */
        ...
        /**
         ...
         @return true on success, false on failure.
        */
        bool addEOPPFile(const std::string& filename);
        ...
        /**
         ...
         @return true on success, false on failure.
        */
        bool addIERSFile(const std::string& filename);

        /**
         Add EOPs to the store via an IGS ERP file.
         @param filename Name of file to read, including path.
         @return true on success, false on failure.
        */
        bool addERPFile(const std::string& filename);
